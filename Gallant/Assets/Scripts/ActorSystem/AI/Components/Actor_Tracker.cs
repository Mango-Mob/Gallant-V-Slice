...
namespace ActorSystem.AI.Components
{
    ...
    public class Actor_Tracker : MonoBehaviour
    {
        ...
        //Stats to record:
        private float[] m_resistanceStat = new float[2];
        ...
        void Update()
        {
            ...
            string display = "";
            display += $"Resist: {m_resistanceStat[0]} | {m_resistanceStat[1]} \n";
         ...
         */
        public void RecordResistance(float phyResist, float abilResist)
        {
            m_resistanceStat[0] = phyResist;
            m_resistanceStat[1] = abilResist;
        }
    }
}
