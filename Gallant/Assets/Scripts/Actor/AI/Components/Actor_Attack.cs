...
namespace Actor.AI.Components
{
    public abstract class Actor_Attack
    {
         ...
         */
        public bool IsWithinRange(Enemy user, int targetLayer)
        {
         ...
         */
        public abstract Collider[] GetOverlap(Enemy user, int targetLayer);
         ...
         * @param : (Actor) the actor who is using this attack.
         */
        public virtual void BeginAttack(Enemy user)
        {
            m_timeSinceLastAttack = DateTime.Now;
        }
         ...
         */
        public virtual void Invoke(Enemy user, Collider hitCollider)
        {
            if (hitCollider.gameObject.layer == LayerMask.NameToLayer("Player"))
            {
                ...
                player.DamagePlayer(m_baseDamage * (user.m_damageModifier), user.gameObject);
            }
        }
         ...
         */
        public virtual uint GetPriority(Enemy user)
        {
            return m_priority;
        }
